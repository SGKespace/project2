text_start = "Здравствуйте. \n\n " \
            "Этот бот поможет вам узнать как хранить вещи на нашем складе с безопасной доставкой.\n\n" \
             ...
             "       <b>Меню:</b>  \n " \
             "<b>Help</b> - часто задаваемые вопросы \n" \
             "<b>CreateOrder</b> - Создание заказа на хранение\n" \
             "<b>MyOrders</b> - Посмотреть список Ваших Ордеров  и пполучить QR на доступ \n" \
             "<b>Contacts</b> - Контакты Директора и адрес склада \n" \
             "<b>Done</b> - выход из бота"
